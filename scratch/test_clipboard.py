...
modified_symbol_block = """(symbol "LCSC_Imports:C3178303"
  (pin_names (offset 0.127))
  (exclude_from_sim no)
  (in_bom yes)
  (on_board yes)
  (property "Reference" "U" (id 0) (at -5.08 6.35) (effects (font (size 1.27 1.27))))
  (property "Value" "C3178303" (id 1) (at 0 6.35 0) (effects (font (size 1.27 1.27))))
  (property "Footprint" "LCSC_Imports:R0402" (id 2) (at 0 0) (effects (font (size 1.27 1.27)) hide))
)"""
